    ...
    return (
        <section id="education" className="flex justify-center pt-16">
            <div className=" max-w-7xl w-10/12 sm:flex sm:gap-8">
                <h2 className="py-4 font-bold text-3xl text-gray-100 sm:w-64">Education</h2>
                <hr className=" h-full border-l border-slate-400 hidden sm:block" />
                <div className="w-full">
                    <div className="flex flex-col gap-8">
                        {experience.map((exp, index) => {
                            return (
                                <div key={index} className="hover:shadow-lg border-r border-slate-500 border-t p-4 rounded-lg">
